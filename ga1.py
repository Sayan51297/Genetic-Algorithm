...
for generation in range(num_generations):
    ...
    best.append(numpy.min(numpy.sum(new_population*equation_inputs, axis=1)))
...
print "Best solution : " + str(new_population[best_match_idx, :])
print "Best solution fitness : " + str(fitness[best_match_idx])
...
plt.title('Plot between Generations v/s their best Fitness values')
